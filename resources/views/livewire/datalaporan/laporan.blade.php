<div class="container-fluid py-4">
 <div wire:poll.keep-alive>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Laporans table</h6>
              </div>
            </div>
            <?php $i = 0; ?>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                   ...
                   <tr>
                    ...
                    <td class="align-middle text-center"><textarea  rows="3.5" cols="20" readonly> {{ $laporan->keterangan}} </textarea></td>
   ...
   @if($isModalOpen)
   @include('livewire.datalaporan.detaillaporan')
   @endif
