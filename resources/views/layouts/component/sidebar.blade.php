<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-2xl my-3 fixed-start ms-3  bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse h-auto w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link text-white {{{ (Request::is('datalaporan') ? 'class= active bg-gradient-info' : '') }}}" href="{{route('Datalaporan')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
